...
<body>
    ...
    <div class="container">
        ...
        <span><svg width="2em" height="3em" onclick="setDarkMode(false)" viewBox="0 0 16 16" class="bi bi-brightness-low" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            <svg width="2em" height="2em" onclick="setDarkMode(true)" viewBox="0 0 16 16" class="bi bi-brightness-low-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
